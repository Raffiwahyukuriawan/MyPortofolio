...
const CATS = [
  ...
  },
  {
    ...
    color: "#A855F7",
    icon: "⚙️",
    tags: ["Laravel", "CodeIgniter 3", "REST API", "PHP", "MySQL"],
  },
  {
    title: "Mobile",
    color: "#10B981",
...
const BARS = [
  { skill: "", pct: 70, color: "#06B6D4" },
  { skill: "", pct: 75, color: "#A855F7" },
  { skill: "", pct: 82, color: "#10B981" },
  { skill: "", pct: 75, color: "#FBBF24" },
  { skill: "", pct: 70, color: "#F43F5E" },
  { skill: "", pct: 65, color: "#A855F7" },
];
                ...
                {CATS.map((c, i) => (
                  ...
                  >
                    <div
                      ...
                      style={{
                        borderColor: `rgba(${hexToRgb(c.color)},.18)`,
                      ...
                      <div className="d-flex flex-wrap gap-1">
                        {c.tags.map((t) => (
                          <span
                            ...
                            style={{
                              color: c.color,
                              borderColor: `rgba(${hexToRgb(c.color)},.25)`,
                              background: `rgba(${hexToRgb(c.color)},.06)`,
                            }}
                          >
                            {t}
                          </span>
